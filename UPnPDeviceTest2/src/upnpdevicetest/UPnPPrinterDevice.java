...
public class UPnPPrinterDevice implements UPnPDevice {
	...
	public UPnPPrinterDevice() {
		...
		props.put(UPnPDevice.UDN, "uuid:PrinterType2-" + getLocalHostname());    
		props.put(UPnPDevice.TYPE, "urn:schemas-prosyst-com:device:UPnPPrinterType:4");
		props.put(UPnPDevice.FRIENDLY_NAME, "UPnPPrinter2");
		...
		props.put(UPnPDevice.MODEL_NAME, "upnpprinter2");
